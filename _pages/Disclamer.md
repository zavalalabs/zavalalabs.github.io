...
The data collected through Google Analytics is used to understand and analyze trends, administer the site, track users’ movements around the site, and gather demographic information. This helps me to improve the content and user experience on my blog by seeing what content is driving visits and engagement.
...
You can opt out of Google Analytics by installing the Google Analytics Opt-out Browser Add-on. This add-on prevents the Google Analytics JavaScript (ga.js, analytics.js, and dc.js) from sharing information with Google Analytics about visit activity.
