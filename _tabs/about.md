...
- **Home Lab & Infrastructure** — My adventures (and misadventures) with Proxmox, networking, and whatever hardware I'm tinkering with this month
- **macOS & Admin Tools** — Deep dives into Apple ecosystems, JAMF, and keeping things organized
...
Honestly? I've always found it helpful to write things down. Whether it's documenting a problem I solved, sharing something I learned, or just venting about technology decisions, writing helps me think. If any of this is useful to you, then that's the cherry on top.
